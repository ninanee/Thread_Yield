...
//                 if(accIndex + 1 == numberOfAccounts){
//                     //All accounts have been processed. Break out and therefore disconnect server
//                     break;
//                 }
        	 }
         }
...
//         objNetwork.disconnect(objNetwork.getServerIP());
    ...
    {   Transactions trans = new Transactions();
        ...
        boolean isProcessed = processTransactions(trans);

        objNetwork.disconnect(objNetwork.getServerIP());

        if(isProcessed && objNetwork.getServerConnectionStatus().equals("disconnected")){
